...
// Validar datos tercer angulo
if (fTercerAngulo <= 0 || fTercerAngulo >= 180){
...
if (fPrimerAngulo == 90 || fSegundoAngulo == 90 || fTercerAngulo == 90){
...
else if (fPrimerAngulo > 90 || fSegundoAngulo > 90 || fTercerAngulo > 90){
    ...
    clasificador(fPrimerAngulo, fSegundoAngulo, fTercerAngulo);
        ...
        printf("No se pudo clasificar el triangulo. \n");
